...
public class En_decrypt {
	...
	public static void main(String[] args) {
		String oldString = "20022.8";
		String SPKEY = "eaju";
		System.out.println("1。分配的SPKEY为: " + SPKEY);
		System.out.println("2。的内容为: " + oldString);
		String reValue = En_decrypt.get3DESEncrypt(oldString, SPKEY);
		reValue = reValue.trim().intern();
		System.out.println("进行3-DES加密后的内容: " + reValue);
		String reValue2 = En_decrypt.get3DESDecrypt(reValue, SPKEY);
