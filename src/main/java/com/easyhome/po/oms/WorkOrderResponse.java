...
public class WorkOrderResponse {
	...
	@JsonProperty("CANCEL_PERSION")
	private String cancelPersion;
	...
	public String getCancelPersion() {
		return cancelPersion;
	}

	public void setCancelPersion(String cancelPersion) {
		this.cancelPersion = cancelPersion;
	}
